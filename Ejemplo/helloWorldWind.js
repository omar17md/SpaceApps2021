...
/*for (var i = 0; i < 100; i++) {
	var position = new WorldWind.Position(55.0, -106.0+i, 100.0);
...
//var config = {dirPath: 'https://raw.githubusercontent.com/omar17md/WebWorldWind/develop/examples/collada_models/duck/'};
var config = {dirPath: 'https://raw.githubusercontent.com/omar17md/challengeapp/main/models/'};

/*for (var i = 0; i < 10; i++) {
	var position = new WorldWind.Position(10.0, -125.0 + i, 800000.0);
	var colladaLoader = new WorldWind.ColladaLoader(position, config);
	colladaLoader.load("ballo.dae", function (colladaModel) {
